...
// HelloArApplication handles all application logics.
    ...
    public:
        ...
        void OnSLAM3DView(int benable);

        void OnScreenSwitch(int benable);
...
//  std::unordered_set<ArAnchor*> tracked_obj_set_;
        ...
        std::string draw_info;
        std::string slam_info;
        ...
        int     m_TouchBeginX, m_TouchBeginY;
        float   m_BeginAlphaAngle, m_BeginThetaAngle;
        float   m_DebugCameraRadius, m_AlphaAngle, m_ThetaAngle;
        float   m_PreDistance;

        float   m_ScreenAspect;
        int     m_ScreenWidth;
        int     m_ScreenHeight;
        int     m_DebugViewportWidth;
        int     m_DebugViewPortHeight;
