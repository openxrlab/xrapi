...
public class JniInterface {
  ...
  public static native void onDoubleTouched(long nativeApplication, float x, float y);

  public static native void onTouchedZoom(long nativeApplication, float scale);

  public static native void onTouchedMove(long nativeApplication, float x, float y);

  public static native void resetTouched(long nativeApplication);
  ...
  public static native boolean isScanStart(long nativeApplication);

  public static native void onStartScan(long nativeApplication);

  public static native void onStopScan(long nativeApplication);

  public static native void onStartScanGuidance(long nativeApplication);

  public static native void onStopScanGuidance(long nativeApplication);

  public static native void resetAlgorithm(long nativeApplication);

  public static native void getScanResult(long nativeApplication);

  public static native int getScanProgress(long nativeApplication);

  public static native boolean isNearPlane(long nativeApplication);
