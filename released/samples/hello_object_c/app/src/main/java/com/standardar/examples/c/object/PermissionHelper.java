...
/* modification list:
 * 1. add WRITE_PERMISSION member
 * 2. add WRITE_PERMISSION_CODE member
 * 3. add hasWritePermission member function
 */
...
public class PermissionHelper {
  ...
  private static final String VIBRATOR_PERMISSION   = Manifest.permission.VIBRATE;
  ...
  public static boolean hasPermission(Activity activity) {
    return ContextCompat.checkSelfPermission(activity, CAMERA_PERMISSION)== PackageManager.PERMISSION_GRANTED
            ...
            && ContextCompat.checkSelfPermission(activity, VIBRATOR_PERMISSION)== PackageManager.PERMISSION_GRANTED;
  }

  /** Check to see we have the necessary permissions for this app, and ask for them if we don't. */
  public static void requestPermission(Activity activity) {
    ActivityCompat.requestPermissions(
            activity, new String[] {WRITE_PERMISSION,CAMERA_PERMISSION,READ_PERMISSION,VIBRATOR_PERMISSION}, CAMERA_PERMISSION_CODE);
  }
