...
#define JNI_METHOD(return_type, method) \
  JNIEXPORT return_type JNICALL         \
      Java_com_standardar_ar_core_examples_c_augmentedimage_JniInterface_##method
...
(JNIEnv *env, jclass, jobject j_asset_manager, jobject context, jstring j_package_name, jstring j_apk_internal_path) {
  ...
  return jptr(new augmented_image::AugmentedImageApplication(asset_manager, env, context, package_name, apk_internal_path));
}
