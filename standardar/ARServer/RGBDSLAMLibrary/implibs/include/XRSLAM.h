...
typedef enum XRSLAMResultType {
    ...
    XRSLAM_RESULT_CORRECTED_POSE,       /*!< body pose, which corrected by drift*/
    XRSLAM_RESULT_KEYFRAME_POSES,       /*!< all keyframe poses*/
    XRSLAM_RESULT_CAMERA_POSE,          /*!< camera pose. */
    XRSLAM_RESULT_STATE,                /*!< system state. */
    XRSLAM_RESULT_BACKEND_RUNNING,      /*!< check if backend is running.*/
    XRSLAM_RESULT_LANDMARKS,            /*!< 3D landmarks. */
    XRSLAM_RESULT_FEATURES,             /*!< 2D features. */
    XRSLAM_RESULT_NORMALIZED_FEATURES,  /*!< 2D features. */
 ...
 * @param[in] voc_path  vocabulary path
